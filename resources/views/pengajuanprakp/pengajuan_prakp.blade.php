...
<head>
	<title>Pengajuan Pra KP | SIKP</title>
	<meta charset="utf-8">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                @if ($pengajuanprakp = Session::get('sukses'))
                                    <div class="alert alert-success alert-block">
                                        <button type="button" class="close" data-dismiss="alert">×</button>
                                        <strong>{{$pengajuanprakp}}</strong>
                                    </div>
                                    @endif
                            <div class="panel">
                                <div class="panel-heading">
                                    <title>Form Pengajuan Pra KP</title>
                                <body>
                                <form action="{{ route('pengajuanprakp.keep') }}" method="POST">
                                    {{csrf_field()}}
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="tools" type="text" class="form-control" placeholder="Masukkan Tools">
                                                @if($errors->has('tools'))
                                                <div class="text-danger">
                                                    {{ $errors->first('tools')}}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="spesifikasi" type="text" class="form-control" placeholder="Masukkan Spesifikasi">
