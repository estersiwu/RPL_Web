...
<head>
	<title>Formulir Pengajuan KP | SIKP</title>
	<meta charset="utf-8">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                @if ($pengajuankp = Session::get('sukses'))
                                    <div class="alert alert-success alert-block">
                                        <button type="button" class="close" data-dismiss="alert">×</button>
                                        <strong>{{$pengajuankp}}</strong>
                                    </div>
                                    @endif
                            <div class="panel">
                                ...
                                <body>
                                <form action="{{ route('pengajuankp.hold') }}" method="POST">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-sm-2"></div>
                                        <div class="col-sm-7">
                                        <h1 align="center">KP</h1>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="nik" type="text" class="form-control" placeholder="Masukkan NIM">
                                            @if($errors->has('nik'))
                                            <div class="text-danger">
                                                {{ $errors->first('nik')}}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="label-control">Judul KP *</label>
                                            <input name="judulkp" type="text" class="form-control" placeholder="Masukkan NIM">
                                            @if($errors->has('judulkp'))
                                            <div class="text-danger">
                                                {{ $errors->first('judulkp')}}
                                            </div>
                                        @endif
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="label-control">Tools *</label>
                                            <input name="tools" type="text" class="form-control" placeholder="Masukkan Lembaga">
                                            @if($errors->has('tools'))
                                            <div class="text-danger">
                                                {{ $errors->first('tools')}}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="spesifikasi" type="text" class="form-control" placeholder="Masukkan Lembaga">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="lembaga" type="text" class="form-control" placeholder="Masukkan Pimpinan">
