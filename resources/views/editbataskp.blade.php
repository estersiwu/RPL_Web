                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="text-center">Edit Batas Pelaksanaan KP</h3>
                                </div>
                                <div class="panel-body">
                                    <form action="/bataskp/{{$bataskp->id}}/update-bataskp" method="POST">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label for="" class="label-control">NIM</label>
                                            <input name="nim" type="text" class="form-control" placeholder="Masukkan NIM" value="{{$bataskp->nim}}">
                                            @if($errors->has('nim'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_mulai" class="form-control" id="tanggal_mulai" aria-describedby="emailHelp" value="{{$bataskp->tanggal_mulai}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal Selesai</label>
                                            <input type="date" name="tanggal_selesai" class="form-control" id="tanggal_selesai" aria-describedby="emailHelp" value="{{$bataskp->tanggal_selesai}}">
                                        </div>
